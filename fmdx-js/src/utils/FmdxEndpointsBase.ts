...
import {FmdxJsConfig, type FmdxJsConfigAuthToken} from './config.js';
import {type InvokeEndpointParams, invokeEndpoint} from './invokeEndpoint.js';
import type {FmdxEndpointParamsOptional} from './types.js';
...
export class FmdxEndpointsBase extends FmdxJsConfig {
  protected getAuthToken(params?: {authToken?: FmdxJsConfigAuthToken}) {
  ...
  protected async executeRaw(
    ...
    p02?: Pick<FmdxEndpointParamsOptional<any>, 'authToken' | 'serverURL'> &
