...
const fmdxDbURL = process.env.FMDX_DB_POSTGRES_DATABASE_URL;

assert.ok(fmdxDbURL, "FMDX_DB_POSTGRES_DATABASE_URL is required");

export const fmdxPostgresDb = drizzle(fmdxDbURL);
